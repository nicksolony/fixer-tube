...
Videos = Video.create([
    {name:"Pair power/volume button on Amazon Firestick" ,description:"In this short video I show you the steps to sync your Amazon Fire TV remote with the volume/power buttons to your tv. This is the 2nd gen Firestick remote with the volume/power button controls.", url:"rrkxz2VWwmM", brand_id:14 ,category_id: 1},
    {name:"Microwave Won’t Turn On - No Power on Microwave" ,description:"There are multiple things that can go bad on an older microwave that cause it not to function properly. This video shows how to locate the issue when there is no power at all.", url:"8i3iYtQOih4", brand_id:6 ,category_id: 4},
    {name:"How To Open/Disassemble a PS4" ,description:"How to disassemble the PS4 to get access to the Motherboard, Disc Drive, Hard Drive and PSU for repair, cleaning or modification.", url:"WVzWK3H3iN4", brand_id:7 ,category_id: 7},
    {name:"AC Wont Turn On - The Most Common Fix" ,description:"AC wont turn on and The Most Common Fix. Is your inside fan working but the unit outside not turning on? There's a very good chance that you have a blown capacitor. Often times you will hear the outside unit buzz for a few seconds as if trying to start and then stops. In this video I show you how to locate, read the rating, replace, and measure the dual capacitor. This is the most common air conditioner repair. BUT.. Keep in mind that this is not a fix it all repair. Its common, but there could be many other things that can go wrong. Let me know in the comments below if you have a problematic AC. I will try to walk you through it ;)", url:"C82HvbvP08E", brand_id:6 ,category_id: 13},
    {name:"A Pair power/volume button on Amazon Firestick" ,description:"In this short video I show you the steps to sync your Amazon Fire TV remote with the volume/power buttons to your tv. This is the 2nd gen Firestick remote with the volume/power button controls.", url:"rrkxz2VWwmM", brand_id:14 ,category_id: 1}
])